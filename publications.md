...
> Keep this list in **newest-first order**. The homepage automatically shows only the first 10 entries; this page displays the complete list.
...
2. **Secure Cooperative Gradient Coding**  
   **Shudi Weng**, Chao Ren, Yizhou Zhao, Ming Xiao, Mikael Skoglund.  
   Submitted to IEEE Journal on Selected Areas in Communications (JSAC), 2025.

3. **Heterogeneity-Aware Client Sampling: A Unified Solution for Consistent Federated Learning**  
   **Shudi Weng**, Chao Ren, Ming Xiao, Mikael Skoglund.  
   Submitted to IEEE Transactions on Signal Processing (TSP), 2025.
...
6. **Cooperative Gradient Coding for Semi-Decentralized Federated Learning**  
